...
class Server(models.Model):
    ...
    member = models.ManyToManyField(settings.AUTH_USER_MODEL, verbose_name="server_member", related_name="server_member")
...
class Channel(models.Model):
    name = models.CharField("Channel", max_length=100)
